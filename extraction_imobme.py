...
class BotExtractionImobme():
    def __init__(self,usuario=None,senha=None, caminho_download=f"{os.getcwd()}\\downloads\\"):
        ...
        self.gerar_relatorios = [
            ...
            #seção para apenas para teste
            #{'action' : self.clicar, 'kargs' : {'target' : '//*[@id="dvEmpreendimento"]/div[1]/div/div/ul/li[3]/a/label/input'}}, # clica no emprendimento 2300
            #{'action' : self.clicar, 'kargs' : {'target' : '//*[@id="dvEmpreendimento"]/div[2]/div/div/button'}},
            #{'action' : self.clicar, 'kargs' : {'target' : '//*[@id="dvEmpreendimento"]/div[2]/div/div/ul/li[2]/a/label/input'}},
            ##############
